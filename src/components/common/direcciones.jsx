...
const Direcciones = props => {
  ...
  return (
    <React.Fragment>
      ...
      <ul className="list-group list-group direccion  lead">
        {/* <li className="list-group-item   border-0 py-0">
            CIF: B30403968{" "}
          </li> */}
        <li className="list-group-item   border-0 py-0 d-flex align-items-center">
          <span className="mr-2 ">
        ...
        <li className="list-group-item   border-0 py-0 d-flex align-items-center">
          ...
          <span>
            <a
              ...
              className="nodecoration text-dark"
            >
              indesan@indesan.com
            </a>
          </span>
        ...
        <li className="list-group-item   border-0 py-0 d-flex align-items-center">
          ...
          <span>
            <a href={"tel:" + t.TE[lan]} className="nodecoration text-dark">
              {t.TE[lan]}
            </a>
          </span>
        </li>
