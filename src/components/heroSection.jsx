              ...
              <div className="heroContainer " style={{backgroundImage: "url(/resources/img/backgrounds/bg1_tn_" + WhichBotstrapBreak(windowWidth, windowHeight) + ".jpg)" }}>
                 <div className="heroOverlay w-100 h-100">
                  <div id="textos" className="col-12 col-md-6 p-4 p-md-4 text-light h-100 ">
                    ...
                    <h2 className="card-title h1 my-4 text-light">El referente de calidad en mesas de comedor</h2>
                    <p className="card-text h5 my-4 font-weight-lighter font-italic">Descubre nuestras colecciones de mesas de comedor modernas, construidas con materiales naturales como maderas, cerámicas y estructuras de acero.</p>
